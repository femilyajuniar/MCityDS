...
import com.azhar.deliserdang.adapter.MainAdapter;
import com.azhar.deliserdang.decoration.LayoutMarginDecoration;
import com.azhar.deliserdang.model.ModelMain;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.onSelectData {
    ...
    private void setMenu() {
        ...
        lsMainMenu.add(mdlMainMenu);
        mdlMainMenu = new ModelMain("Data Covid", R.drawable.ic_komunitas);
        lsMainMenu.add(mdlMainMenu);
